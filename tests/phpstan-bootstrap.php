 ...
 * PHPStan cannot evaluate statically. Real values are set in collapsi-for-gutenberg.php.
 *
 * @package Collapsi
 */
...
defined( 'COLLAPSI_URL' ) || define( 'COLLAPSI_URL', 'https://example.com/wp-content/plugins/collapsi-for-gutenberg/' );
